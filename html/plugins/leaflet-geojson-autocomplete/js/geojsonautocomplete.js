...
(function ($) {
    ...
    function createDropDown(withPaging) {
        ...
        for (var i = 0; i < loopCount; i++) {
            ...
            html += "<span id='listElementContent" + i + "' class='atuocontent'><img src='./images/" + features[i].properties.image + "' class='iconStyle' align='middle'>";
        ...
        if (withPaging) {
            ...
            var htmlPaging = "<div align='right' class='pagingDiv'>" + ((offset -1 ) * options.limit + 1) + " - " + (offset * options.limit) + " " + options.foundRecordsMessage + " ";
            htmlPaging += "<input id='pagingPrev' type='image' src='../map/images/" + prevPic + "' width='16' height='16' class='pagingArrow' " + prevDisabled + ">";
            htmlPaging += "<input id='pagingNext' type='image' src='../map/images/" + nextPic + "' width='16' height='16' class='pagingArrow' " + nextDisabled + "></div>";
    ...
    function drawGeoJson(index) {
        ...
        if (features[index].geometry.type === "Point" && options.pointGeometryZoomLevel !== -1) {
            map.flyTo([features[index].geometry.coordinates[1], features[index].geometry.coordinates[0]], options.pointGeometryZoomLevel);
        }
        else {
            map.fitBounds(searchLayer.getBounds());
        }
