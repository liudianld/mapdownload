...
L.TileLayer.BaiduLayer = L.TileLayer.extend({
    ...
    initialize: function (type, options) {
        ...
        var url = desc[type];
        options = options || {};
        options.subdomains = desc[type].subdomains || desc.subdomains;
...
L.TileLayer.BaiduLayer.desc = {
    ROADMAP: 'http://online{s}.map.bdimg.com/tile/?qt=tile&x={x}&y={y}&z={z}&styles=pl',
    SATELLITE: 'http://shangetu{s}.map.bdimg.com/it/u=x={x};y={y};z={z};v=009;type=sate&fm=46',
    HYBRID: 'http://online{s}.map.bdimg.com/tile/?qt=tile&x={x}&y={y}&z={z}&styles=sl&v=039&udt=20140314',
