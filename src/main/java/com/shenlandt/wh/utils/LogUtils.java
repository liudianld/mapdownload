...
public class LogUtils {
    ...
    public static final Logger ERROR_LOG = LoggerFactory.getLogger("ipro-error");
    public static final Logger ACCESS_LOG = LoggerFactory.getLogger("ipro-access");
     ...
     * @param request
     */
    public static void logAccess(HttpServletRequest request, String username) {
     ...
     * @param e
     */
    public static void logError(String message, String username, Throwable e) {
        StringBuilder s = new StringBuilder();
     ...
     * @param request
     */
    public static void logPageError(HttpServletRequest request, String username) {
