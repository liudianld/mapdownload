...
public class StreamUtility {
	...
	public static byte[] convertToByteArray2(InputStream is) throws Throwable{
        if( null == is ) return null;
        byte[] bytes = IOUtils.toByteArray(is);
        return bytes;
    }
	
	public static ByteArrayInputStream convertToByteArrayInputStream(InputStream is) throws Throwable{
        if( null == is ) return null;
        
        return new ByteArrayInputStream(convertToByteArray2(is));
    }
